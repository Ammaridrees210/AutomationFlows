...
test.describe('Login Tests',() => {
    ...
    test.only('User should Able to access the Forget Password', async ({ page }) => {
        test.slow();
        await login(process.env.EMAIL, '12345', page);
        ...
        await page.click(loginSelectors.requestResetLinkSelector());
        expect(await page.textContent(loginSelectors.verificationMassageOfEmailSend())).toBe('Please Check Your Inbox');
        await page.click(loginSelectors.requestToReturnLoginPage());
    })
